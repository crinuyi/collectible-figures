namespace collectible_figures.Migrations
{
    ...
    public partial class collectiblefigures : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Figures", "SeriesID", "dbo.Series");
            DropForeignKey("dbo.Figures", "ClassificationID", "dbo.Classifications");
            ...
            DropIndex("dbo.Figures", new[] { "SeriesID" });
            DropIndex("dbo.Figures", new[] { "ClassificationID" });
